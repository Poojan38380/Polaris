...
const SLIDES = [
    {
        ...
        sub: "Just describe what you want. Forge reads your files and makes it happen.",
    },
    {
    ...
    },
    {
        ...
        sub: "Type an idea. Forge scaffolds the entire project in seconds.",
    },
    {
        ...
        <div className={cn("flex h-screen w-full overflow-hidden bg-sidebar", font.className)}>
            ...
            <div className="relative hidden lg:flex flex-col w-[60%] h-full overflow-hidden bg-sidebar">
                ...
                <div className="relative z-10 flex items-center gap-2.5 p-8">
                    <Image src="/logo.svg" alt="Forge" width={36} height={36} />
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-10 gap-6">
                    ...
                    <div className="relative w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 shadow-2xl">
                        {/* Top fade */}
                        <div className="pointer-events-none absolute top-0 left-0 right-0 h-8 z-10 bg-gradient-to-b from-sidebar to-transparent" />
                        {/* Bottom fade */}
                        <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-12 z-10 bg-gradient-to-t from-sidebar to-transparent" />
            ...
            <div className="flex flex-col items-center justify-center flex-1 h-full bg-background border-l border-border/50 px-8 py-12">
                ...
                <div className="w-full max-w-sm flex flex-col gap-8">
                    ...
                    <div className="flex items-center gap-2.5 lg:hidden">
                        <Image src="/logo.svg" alt="Forge" width={32} height={32} />
                        <span className="text-xl font-semibold text-foreground">Forge</span>
                    </div>

                    {/* Headline */}
                    <div className="space-y-2">
                        <h1 className="text-3xl font-bold text-foreground leading-tight">
                            Forge your ideas<br />into reality.
                        </h1>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            Your AI-powered coding partner. Describe what you want to build —
                            Forge writes the code, runs it live, and pushes it to GitHub.
                        </p>
                    </div>
                    ...
                    {/* GitHub link */}
                    <a
                        href="https://github.com/Poojan38380/Forge"
                        target="_blank"
